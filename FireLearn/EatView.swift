...
@StateObject var chicken = Food(name: "chicken", quantity: 2, isVisible: false, progress: 0)
@StateObject var piggy = Food(name: "piggy", quantity: 2, isVisible: false, progress: 0)
@StateObject var batata = Food(name: "batata", quantity: 2, isVisible: false, progress: 0)
