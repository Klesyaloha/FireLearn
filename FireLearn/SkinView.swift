...
@StateObject private var glasses = Article(name: "glasses", isVisible: false)
@StateObject private var chapeau = Article(name: "chapeau", isVisible: false)
@StateObject private var noeud = Article(name: "noeud", isVisible: false)
